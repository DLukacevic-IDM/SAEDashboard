 ...
 */
export function extraInfo(indicator) {
  const lineStyle = {padding: '10px 20px', width: '100%', fontSize: '0.9rem'};

  switch (indicator) {
    default:
      return (
        <div style={lineStyle}><FormattedMessage id={indicator+'_extra_info'}/></div>
      );
  }
}
